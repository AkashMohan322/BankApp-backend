...
server.use(express.json())//Returns middleware tht only parse json
...
//  //6. API call to resolve - localhost:5000
//  server.get('/',(req,res)=>{
...
server.get('/getbalance/:acno',jwtMiddleware,(req,res)=>{
   ...
   console.log(req.params);//http://localhost:5000/getbalance/7
